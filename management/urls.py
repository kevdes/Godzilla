...
urlpatterns = patterns('',
	...
	# ex: /management/5/    
    url(r'^client/new/$', views.CreateClientView, name='client-new'),
	url(r'^clients/$', views.ListClientView, name='client-list'),
	url(r'^client/(?P<pk>\d+)/$', views.DetailClientView, name='client-detail'),
	url(r'^client/edit/(?P<pk>\d+)/$', views.UpdateClientView, name='client-edit'),
	...
	url(r'^title/(?P<pk>\d+)/$', views.DetailTitleView, name='title-detail'),	
