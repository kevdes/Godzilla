...
urlpatterns = patterns('',
	...
	# ex: /management/5/    
    url(r'^newclient$', views.CreateClientView.as_view(), name='client-new'),
	...
	url(r'^newtitle$', views.createTitle, name='title-new'),
	url(r'^newtitle/(?P<client_id>\d+)/$', views.createTitleClient, name='title-new-client'),	
