...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'management_product', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Product.date_updated'
        db.add_column(u'management_product', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Client.date_created'
        db.add_column(u'management_client', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Client.date_updated'
        db.add_column(u'management_client', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ProductStatus.display_order'
        db.add_column(u'management_productstatus', 'display_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Title.date_created'
        db.add_column(u'management_title', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Title.date_updated'
        db.add_column(u'management_title', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'management_product', 'date_created')

        # Deleting field 'Product.date_updated'
        db.delete_column(u'management_product', 'date_updated')

        # Deleting field 'Client.date_created'
        db.delete_column(u'management_client', 'date_created')

        # Deleting field 'Client.date_updated'
        db.delete_column(u'management_client', 'date_updated')

        # Deleting field 'ProductStatus.display_order'
        db.delete_column(u'management_productstatus', 'display_order')

        # Deleting field 'Title.date_created'
        db.delete_column(u'management_title', 'date_created')

        # Deleting field 'Title.date_updated'
        db.delete_column(u'management_title', 'date_updated')


    models = {
        u'management.asset': {
            'Meta': {'object_name': 'Asset'},
            'asset_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['management.AssetType']"}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['management.AssetStatus']"})
        },
        u'management.assetstatus': {
