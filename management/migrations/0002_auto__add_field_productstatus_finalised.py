...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductStatus.finalised'
        db.add_column(u'management_productstatus', 'finalised',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductStatus.finalised'
        db.delete_column(u'management_productstatus', 'finalised')
