...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportItem'
        db.create_table(u'testing_reportitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('asset_report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authoring.AssetReport'])),
            ('cer_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testing.CentralUser'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('severity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testing.ReportItemSeverity'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'testing', ['ReportItem'])

        # Adding model 'ReportItemSeverity'
        db.create_table(u'testing_reportitemseverity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'testing', ['ReportItemSeverity'])


    def backwards(self, orm):
        # Deleting model 'ReportItem'
        db.delete_table(u'testing_reportitem')

        # Deleting model 'ReportItemSeverity'
        db.delete_table(u'testing_reportitemseverity')
