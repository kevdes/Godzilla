...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CentralUser'
        db.create_table(u'testing_centraluser', (
        ...
        db.send_create_signal(u'testing', ['CentralUser'])


    def backwards(self, orm):
        # Deleting model 'CentralUser'
        db.delete_table(u'testing_centraluser')
