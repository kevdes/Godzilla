...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'testing_reportresponsestatus', (
        ...
        db.send_create_signal(u'testing', ['ReportResponseStatus'])

        # Adding field 'ReportItem.response_comment'
        db.add_column(u'testing_reportitem', 'response_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ReportItem.response_user'
        db.add_column(u'testing_reportitem', 'response_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReportItem.response_status'
        db.add_column(u'testing_reportitem', 'response_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testing.ReportResponseStatus'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReportItem.response_date'
        db.add_column(u'testing_reportitem', 'response_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'testing_reportresponsestatus')

        # Deleting field 'ReportItem.response_comment'
        db.delete_column(u'testing_reportitem', 'response_comment')

        # Deleting field 'ReportItem.response_user'
        db.delete_column(u'testing_reportitem', 'response_user_id')

        # Deleting field 'ReportItem.response_status'
        db.delete_column(u'testing_reportitem', 'response_status_id')

        # Deleting field 'ReportItem.response_date'
        db.delete_column(u'testing_reportitem', 'response_date')
