...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetReport.completed'
        db.add_column(u'authoring_assetreport', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetReport.completed'
        db.delete_column(u'authoring_assetreport', 'completed')
