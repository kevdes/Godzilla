...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetReport.submitted_by'
        db.add_column(u'authoring_assetreport', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetReport.submitted_by'
        db.delete_column(u'authoring_assetreport', 'submitted_by_id')
