...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetReport.created_by'
        db.add_column(u'authoring_assetreport', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='creator', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetReport.created_by'
        db.delete_column(u'authoring_assetreport', 'created_by_id')
