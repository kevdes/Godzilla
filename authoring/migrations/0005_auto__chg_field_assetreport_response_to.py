...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssetReport.response_to'
        db.alter_column(u'authoring_assetreport', 'response_to_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authoring.AssetReport'], null=True))

    def backwards(self, orm):

        # Changing field 'AssetReport.response_to'
        db.alter_column(u'authoring_assetreport', 'response_to_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['authoring.AssetReport']))
