...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'authoring_asset', 'status_id')


    def backwards(self, orm):
        # Adding field 'Asset.status'
        db.add_column(u'authoring_asset', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['authoring.AssetStatus']),
                      keep_default=False)
