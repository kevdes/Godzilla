...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetReport.disc_number'
        db.add_column(u'authoring_assetreport', 'disc_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetReport.disc_number'
        db.delete_column(u'authoring_assetreport', 'disc_number')
    ...
    models = {
        ...
        u'authoring.assetreport': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'disc_number': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
