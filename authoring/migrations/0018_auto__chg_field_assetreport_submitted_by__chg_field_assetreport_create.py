...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssetReport.submitted_by'
        db.alter_column(u'authoring_assetreport', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AssetReport.created_by'
        db.alter_column(u'authoring_assetreport', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'AssetReport.submitted_by'
        db.alter_column(u'authoring_assetreport', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'AssetReport.created_by'
        db.alter_column(u'authoring_assetreport', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
