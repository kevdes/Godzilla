...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetReportStatus.asset_type'
        db.add_column(u'authoring_assetreportstatus', 'asset_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['authoring.AssetType']),
                      keep_default=False)

        # Adding field 'AssetReportStatus.report_type'
        db.add_column(u'authoring_assetreportstatus', 'report_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetReportStatus.asset_type'
        db.delete_column(u'authoring_assetreportstatus', 'asset_type_id')

        # Deleting field 'AssetReportStatus.report_type'
        db.delete_column(u'authoring_assetreportstatus', 'report_type')
