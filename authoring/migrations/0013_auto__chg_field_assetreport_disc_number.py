...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssetReport.disc_number'
        db.alter_column(u'authoring_assetreport', 'disc_number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AssetReport.disc_number'
        db.alter_column(u'authoring_assetreport', 'disc_number', self.gf('django.db.models.fields.IntegerField')(default=1))
